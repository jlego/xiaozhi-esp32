...
class EspWatchS3a3Board : public WifiBoard {
private:
...
public:
    EspWatchS3a3Board() : boot_button_(BOOT_BUTTON_GPIO) {
        InitializeI2c();
    ...
    // virtual PCF8563* GetRtc() override {
    //     return rtc_;
    // }

    SleepTimer* GetPowerSaveTimer() override {
        return power_save_timer_;
    }
};

DECLARE_BOARD(EspWatchS3a3Board);